...
Context: joined a fintech startup as the first QA hire; iOS + Android trading app; two weeks to public launch; no existing suite; real user funds. Full narrative reasoning is in TASK2_QA_STRATEGY.docx / TASK2_QA_STRATEGY.pdf — this section formalizes it into a plan.
...
- **Exit (see Release Readiness Checklist, RELEASE_READINESS_CHECKLIST.docx / .pdf):** all Sev1/Sev2 defects closed, automated suite green on both platforms, manual smoke pass complete on real devices, rollback/kill-switch verified.
